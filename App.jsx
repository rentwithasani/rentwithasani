          ...
          <div>
            ...
            <div className="mt-3 space-y-3 text-sm text-zinc-700">
                ...
                <div className="mt-2 space-y-1 text-xs">
                  ...
                  <label className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      auto insurance or credit card may{" "}
              ...
              <div className="border rounded-2xl p-3 bg-zinc-50">
                ...
                {showEzPassDetails && (
                  <p className="mt-1 text-[11px] text-zinc-500">
                    When you opt in to the toll device, all eligible tolls incurred
                    during your rental will be charged to the card on file, plus
                    any service or processing fees described in your rental
                    agreement. Unpaid tolls and violations may result in additional
                    charges.
                  </p>
                )}
              ...
              <div className="border rounded-2xl p-3 bg-zinc-50">
                ...
                <p className="mt-1 text-xs text-zinc-500">
                  Pricing applies per seat, per day. Final totals will be confirmed
                  in your rental agreement or by our team.
                </p>
                <button
                  type="button"
                ...
                {showAmenitiesDetails && (
                  <p className="mt-1 text-[11px] text-zinc-500">
                    ...
                    passenger's age and size. Availability may vary by vehicle and
                    local regulations. Our team can help confirm fit and
