...
// Vehicles with direct image URLs
...
function VehiclesPage({ vehicles, onSelect, canReserve = true }) {
  return (
    <section className="max-w-6xl mx
...
{vehicles.map((v) => (
<VehicleCard key={v.id} v={v} onSelect={onSelect} canReserve={canReserve} />
))}
</div>
</section>
);
...
<form className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4 p-6 border rounded-2xl bg-white" onSubmit={handleSubmit} >
<label className="flex flex-col text-sm text-zinc-700 md:col-span-1">
Full name
<input name="name" className="mt-2 p-2 border rounded" required placeholder="John Doe" />
</label>
<label className="flex flex-col text-sm text-zinc-700 md:col-span-1">
Email
<input name="email" type="email" className="mt-2 p-2 border rounded" required placeholder="you@domain.com" />
</label>
<label className="flex flex-col text-sm text-zinc-700 md:col-span-1">
Phone
<input name="phone" className="mt-2 p-2 border rounded" required placeholder="(555) 555-5555" />
</label>
<label className="flex flex-col text-sm text-zinc-700 md:col-span-1">
Service type
<select name="serviceType" className="mt-2 p-2 border rounded" defaultValue="sprinter" >
<option value="sprinter">Sprinter</option>
<option value="black-suv">Black truck / black SUV</option>
<option value="elite-luxury">Elite luxury sedan</option>
<option value="armed-chauffeur">
...
<label className="flex flex-col text-sm text-zinc-700">
Date
<input name="date" type="date" className="mt-2 p-2 border rounded" required />
</label>
<label className="flex flex-col text-sm text-zinc-700">
Time
<input name="time" type="time" className="mt-2 p-2 border rounded" required />
</label>
<label className="flex flex-col text-sm text-zinc-700">
Number of passengers
<input name="passengers" type="number" min="1" className="mt-2 p-2 border rounded" placeholder="2" />
</label>
<label className="flex flex-col text-sm text-zinc-700">
Estimated hours
<input name="hours" type="number" min="1" className="mt-2 p-2 border rounded" placeholder="4" />
</label>
<label className="flex flex-col text-sm text-zinc-700 md:col-span-2">
Pick-up location
<input name="pickup" className="mt-2 p-2 border rounded" required placeholder="Hotel / address / airport" />
</label>
<label className="flex flex-col text-sm text-zinc-700 md:col-span-2">
Drop-off or itinerary
<input name="dropoff" className="mt-2 p-2 border rounded" required placeholder="Destination or brief itinerary" />
</label>
<label className="flex flex-col text-sm text-zinc-700 md:col-span-2">
Notes
<textarea name="notes" rows={4} className="mt-2 p-2 border rounded" placeholder="Flight details, occasion (wedding, corporate, night out), security needs, or special requests." />
</label>
<div className="md:col-span-2 flex justify-end">
<button type="submit" className="px-6 py-3 rounded-2xl bg-black text-white text-sm font-semibold" >
Submit request
</button>
</div>
</form>
...
<label className="flex flex-col mt-3 text-sm text-zinc-700">
Email
<input name="email" className="mt-2 p-2 border rounded" required type="email" />
</label>
<label className="flex flex-col mt-3 text-sm text-zinc-700">
Message
<textarea name="message" className="mt-2 p-2 border rounded" rows={4} required />
</label>
<div className="mt-4">
<button className="px-4 py-2 rounded-2xl bg-black text-white text-sm">
Send message
...
/>
<div className="mt-3 flex justify-end">
<button type="submit" className="px-4 py-2 rounded-2xl bg-black text-white text-sm" >
Subscribe
</button>
</div>
</form>
